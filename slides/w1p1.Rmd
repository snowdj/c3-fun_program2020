...
* How have you been dealing with the social distancing?
...
* Let's keep open communication throughout the term

* .b[You] and .b[your loved ones] matter more than this course. Please always keep them first.
...
.pull-left[
# [website](https://uo-datasci-specialization.github.io/c3-fun_program2020/)
]

.pull-right[
  .right[
# [repo](https://github.com/uo-datasci-specialization/c3-fun_program2020)
  ]
]
...
---
# Learning objects for this course
...
* Take-home portion to demonstrate ability to write the correct code (assigned 4/20; 50 points)
