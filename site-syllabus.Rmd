...
### Not required
1. Wickham, H. and Bryan, J. (in development). *[R Packages: Organize, test, 
   document and share your code (second edition)](https://r-pkgs.org)*.
2. Wickham, H. (2020). *[Mastering shiny](https://mastering-shiny.org)*.
...
as well). This will include an in-class quiz (10 points) and a take-home project (50 points) which can be completed in groups.
...
By the end of Week 9, you must have a draft of your final project
